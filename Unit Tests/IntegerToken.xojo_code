...
Inherits M_Token.Token
	...
	#tag Event , Description = 
		Sub GetNextTokenParsers(parsers() As M_Token.ParserDelegate, settings As Variant)
		  ...
		  if settings.Type = Variant.TypeBoolean and settings.BooleanValue then
		    parsers.AddRow AddressOf DoubleToken.ParseDouble
		  end if
		  parsers.AddRow AddressOf ParseInteger
	...
	#tag Method, Flags = &h0
		Shared Function ParseInteger(mb As MemoryBlock, p As Ptr, ByRef bytePos As Integer, context As M_Token.BeginBlockToken, settings As Variant) As M_Token.Token
