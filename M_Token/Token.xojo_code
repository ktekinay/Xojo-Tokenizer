...
Protected Class Token
	...
	#tag Method, Flags = &h0
		Function GetNextToken(mb As MemoryBlock, p As Ptr, ByRef bytePos As Integer, context As M_Token.BeginBlockToken, tokens() As M_Token.Token, settings As Variant) As M_Token.Token
		  return RaiseEvent GetNextToken( mb, p, bytePos, context, tokens, settings )
	...
	#tag Hook, Flags = &h0, Description = 
		Event GetNextToken(mb As MemoryBlock, p As Ptr, ByRef bytePos As Integer, context As M_Token.BeginBlockToken, tokens() As M_Token.Token, settings As Variant) As M_Token.Token
	#tag EndHook
